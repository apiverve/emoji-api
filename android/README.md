...
```gradle
dependencies {
    implementation 'com.github.apiverve:emoji-api:1.1.13'
}
```
...
```java
import com.apiverve.emoji.EmojiLookupAPIClient;
import com.apiverve.emoji.APIResponse;
import com.apiverve.emoji.APIException;

// Initialize the client
EmojiLookupAPIClient client = new EmojiLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("emoji", "🥳");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/emoji](https://docs.apiverve.com/ref/emoji)
...
- **Documentation:** [https://docs.apiverve.com/ref/emoji](https://docs.apiverve.com/ref/emoji)
- **Issues:** [GitHub Issues](https://github.com/apiverve/emoji-api/issues)
