...
/**
 * Client for the Emoji Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/emoji?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/emoji';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EmojiClient] {$message}\n";
        }
    }
}
