// Package emoji provides a Go client for the Emoji Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/emoji?utm_source=go&utm_medium=readme
package emoji
...
// Request contains the parameters for the Emoji Lookup API.
//
// Parameters:
//   - emoji (required): string - The emoji for which you want to get the text representation (e.g., 🥳)
type Request struct {
	Emoji string `json:"emoji"` // Required
}
...
// ResponseData contains the data returned by the Emoji Lookup API.
type ResponseData struct {
	Count int `json:"count"`
	EmojisFound []EmojisFoundItem `json:"emojisFound"`
}

// EmojisFoundItem represents an item in the EmojisFound array.
type EmojisFoundItem struct {
