...
const (
	baseURL        = "https://api.apiverve.com/v1/emoji"
	defaultTimeout = 30 * time.Second
)

// Client is the Emoji Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Emoji Lookup API client.
...
// Execute makes a request to the Emoji Lookup API with typed parameters.
//
