...
```bash
curl -X GET "https://api.apiverve.com/v1/emoji?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/emoji](https://docs.apiverve.com/ref/emoji)

---

## Use Cases

Common use cases for the Emoji Lookup API:
