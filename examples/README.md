# Emoji Lookup API - Examples

This folder contains example code for using the Emoji Lookup API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/emoji', {
...
response = requests.get('https://api.apiverve.com/v1/emoji',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/emoji");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/emoji](https://docs.apiverve.com/ref/emoji)
